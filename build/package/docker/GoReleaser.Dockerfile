...
RUN apt-get -qq update && apt-get -qq upgrade -y && \
    ...
    curl --proto '=https' --tlsv1.2 -fsSL https://packagecloud.io/varnishcache/varnish76/gpgkey | gpg --dearmor -o /etc/apt/keyrings/varnishcache-archive-keyring.gpg && \
...
RUN cd /exporter && \
    ...
    rm /tmp/prometheus_varnish_exporter-${EXPORTER_VERSION}.linux-${ARCH}.tar.gz && \
